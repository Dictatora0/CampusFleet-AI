...
import pytest
from agents import SchedulerAgent, SchedulingStrategy, CarAgent, OrderAgent
...
class TestSchedulingWithAssignmentTracking:
    ...
    def test_assignment_history_tracking(self, scheduler_greedy, sample_cars, sample_orders, grid_env):
        """测试分配历史跟踪"""
