...
class DataLogger:
    ...
    def log_order_event(self, step: int, event_type: str, order_id: int, 
                       pickup: tuple = None, delivery: tuple = None, car_id: int = None):
        """
        记录订单事件
        Args:
            step: 当前步数
    ...
    def log_scheduler_event(self, step: int, num_assignments: int, 
