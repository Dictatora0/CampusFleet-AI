...
class Simulation:
            ...
            try:
                ...
                if cmd == "quit" or cmd == "exit" or cmd == "q":
                    ...
                    for i in range(steps):
                        if self.auto_mode and self.context.current_step % self.auto_order_interval == 0:
                            self.context.add_random_order()
    ...
    def _print_final_statistics(self):
        ...
        print("\n车辆表现:")
        for car_info in stats['cars']:
            print(f"  车辆{car_info['car_id']}: 完成{car_info['completed_orders']}单, "
