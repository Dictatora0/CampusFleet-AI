...
fixes = {
    ...
    'algorithms/vrp_solver.py': {
        'unused_imports': ['random']
    },
    'analytics/visualization.py': {
        'unused_imports': ['typing.List']
    },
    'core/config.py': {
        'unused_imports': ['typing.Optional']
    },
    ...
    'core/decorators.py': {
        'unused_imports': ['typing.Any']
    },
    'core/logger.py': {
        'unused_imports': ['datetime.datetime']
    },
    'core/simulation.py': {
        'unused_imports': ['typing.Optional']
    },
    'demos/demo_gui.py': {
        'bare_except_lines': [116]
    },
    ...
    'rl_agents/dqn_agent.py': {
        'unused_imports': ['typing.Tuple'],
        'unused_vars': {'loss': 449}
    },
